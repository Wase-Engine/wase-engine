...
namespace wase
{
    ...
    void Button::update(float dt)
    {
        ...
        textPosition.x = int(rectangle->rect.x + textOffset.x);
        textPosition.y = int(rectangle->rect.y + textOffset.y);
    ...
    void Button::updateText()
    {
        ...
        case TextAlignment::TOP_CENTER:
            textOffset.x = (float)((buttonSize.w / 2) - (getTextSize().w / 2));
            textOffset.y = 0;
            break;
        case TextAlignment::TOP_RIGHT:
            textOffset.x = (float)(buttonSize.w - getTextSize().w);
            textOffset.y = 0;
            break;
        case TextAlignment::MIDDLE_LEFT:
            textOffset.x = 0;
            textOffset.y = (float)((buttonSize.h / 2) - (getTextSize().h / 2));
            break;
        ...
        case TextAlignment::BOTTOM_LEFT:
            textOffset.x = 0;
            textOffset.y = (float)(buttonSize.h - getTextSize().h);
            break;
